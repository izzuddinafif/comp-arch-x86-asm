...
XD: 
 ...
 MOV AL,0FFH  ;set rs to 1 to input data
 MOV DX,PORTB
 OUT DX,AL  
...
MOV AL,00H  ;set rs to 0
 ...
 OUT DX,AL
 MOV CX,00FFH; Delay 
Delay321:loop Delay321
 MOV AL,0FFH
 MOV DX,PORTC
 OUT DX,AL 
 MOV CX,00FFH; Delay 
Delay331:loop Delay331
MOV AL,00H
 MOV DX,PORTC
 OUT DX,AL  
...
MOV AL,00H              
 ...
 OUT DX,AL
 MOV CX,00FFH; Delay 
DelayXX2:loop DelayXX2
 MOV AL,0FFH
 MOV DX,PORTC
 OUT DX,AL 
  MOV CX,00FFH; Delay 
DelayX12:loop DelayX12
MOV AL,00H
 MOV DX,PORTC
 OUT DX,AL  
